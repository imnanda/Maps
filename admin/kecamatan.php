...
$data_kecamatan = $data_kecamatan->ambilData();
...
<head>
    <meta charset="UTF-8">
    <title>AdminDISPERAN | Kecamatan</title>
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <button data-toggle="modal" data-target="#modalTambahKecamatan" style="cursor:pointer"
                                ...
                                <span class="glyphicon glyphicon-plus"></span> Tambah Data Kecamatan
                            </button>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="dataKecamatan" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                while ($kecamatan = $data_kecamatan->fetch_object()) {
                                    ?>
                                    <tr>
                                        <td><?php echo $kecamatan->kodePos; ?></td>
                                        <td><?php echo $kecamatan->namaKecamatan; ?></td>
                                        <td align="center">
                                            <div class="input-group inline">
                                                <button data-toggle="modal" data-target="#modalUbahKecamatan"
                                                        style="cursor:pointer" type="submit"
                                                        data-id="<?php echo $kecamatan->idKecamatan; ?>"
                                                        data-kodepos="<?php echo $kecamatan->kodePos; ?>"
                                                        data-namakecamatan="<?php echo $kecamatan->namaKecamatan; ?>"
